...
class ItemVentaLabel(RecycleDataViewBehavior, BoxLayout):
    ...
    def refresh_view_attrs(self, rv, index, data):
        ...
        self.ids['_cantidad'].text = str(data['cantidad'])
        self.ids['_precio_por_articulo'].text = str("{:.2f}".format(data['precio']))+" /articulo"
...
class InfoVentaPopup(Popup):
    ...
    def __init__(self, venta, **kwargs):
        ...
        self.venta=[{"codigo": producto[3], "producto": QueriesSQLite.execute_read_query(self.connection, self.
            select_item_query, (producto[3],))[0][0], "cantidad": producto[4], "precio": producto[2], "total": producto[4]*
            producto[2]} for producto in venta]
            ...
            for venta in self.productos_actuales:
                for item in venta:
                    ...
                    if item_found:
                        ...
                        productos_csv.append({'nombre': nombre, 'codigo': item[3], 'cantidad': item[4], 'precio': item[2], 
